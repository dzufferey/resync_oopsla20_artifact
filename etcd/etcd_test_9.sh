...
exec $ETCD/bin/etcd --name s$id \
	...
	--initial-cluster s1=http://REPLICA0:2380,s2=http://REPLICA1:2380,s3=http://REPLICA2:2380,s4=http://REPLICA3:2380,s5=http://REPLICA4:2380,s6=http://REPLICA5:2380,s7=http://REPLICA6:2380,s8=http://REPLCA7:2380,s9=http://REPLICA8:2380 \
